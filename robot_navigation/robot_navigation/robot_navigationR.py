...
class Navigation(Node):
    def __init__(self):
        ...
        self.width=352 # 640 et 352
        self.height=288 #480  et  288
        self.line_state=""
        self.tournant_state=""
        ...
        if self.line_state=="red":
            ...
            if self.in_tournant_droite == "droit":
                ...
                if elapsed < 7.0:
                    ...
                    self.message.linear.x = 0.1      #0.04
                ...
                if elapsed < 5:
                    ...
                    self.message.angular.z = -0.5     #0.3
                else:
                ...
                if abs(error_y)>0.01:
                    self.message.linear.x=0.1   #0.05
                else:
                    self.message.linear.x=0.0
            ...
            if self.in_tournant_gauche == "droit_g":
                ...
                if elapsed < 3.5:
                    self.get_logger().info(" je tourne")
                    self.message.linear.x = 0.0
                    self.message.angular.z = +0.1 #0.05
                else:
